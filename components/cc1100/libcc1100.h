...
#define MODULE_DEBUG
#ifdef MODULE_DEBUG
#define SCK_PIN		14 //18  //14	// SPI CLOCK
#define MISO_PIN	12 //19  //27	// SPI MISO (input)
#define MOSI_PIN	13 //23  //26	// SPI MOSI
#define SS_PIN		32 //5  //12	// SPI CS
#define GDO2		25 //25	// input from GD02
#define GDO0		 2 //33	// ADC input, set to 0 if you don't want to use it
#else
#define SCK_PIN		18	// SPI CLOCK
#define MISO_PIN	19	// SPI MISO (input)
#define MOSI_PIN	23	// SPI MOSI
#define SS_PIN		5	// SPI CS
#define GDO2		4	// input from GD02
#define GDO0		2	// ADC input, set to 0 if you don't want to use it
#endif
